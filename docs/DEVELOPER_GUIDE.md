...
### 6. Question Bank Management, Amendment Governance & Export (`/admin/questions`)
...
- **ICAI Amendment & Legal Lifecycle**: When accounting standards or tax laws change, material modifications spawn a new active version snapshot while preserving historical versions in archived status, preventing retroactive grading alterations on past student mock tests.
